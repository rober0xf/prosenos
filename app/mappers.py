...
from app.constants import LEAGUES, MATCH_TIMEZONE
from app.domain.schemas.data import ExternalMatchesResponse, GameData
from app.domain.schemas.match import Match
from app.helpers import format_scorers, to_int_pair
...
def map_match(game: GameData, league_name: str) -> Match:
    ...
    kickoff_dt = (
        datetime.strptime(start_time_str, "%d-%m-%Y %H:%M").replace(
